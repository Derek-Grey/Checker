...
def backtest(data_directory, frequency, stock_path, return_file, use_equal_weights):
...
if __name__ == "__main__":
    backtest(
        ...
        stock_path=r'D:\Derek\Code\Checker\data\test_daily_weight.csv',  # 使用原始字符串
        return_file=None,  # 使用双反斜杠
